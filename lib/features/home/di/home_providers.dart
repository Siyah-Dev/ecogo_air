...
final airportRemoteDataSourceProvider =
    Provider<AirportRemoteDatasource>(
  (ref) => AirportRemoteDatasource(
    ref.read(airportDioProvider),
  ),
);

final flightRemoteDataSourceProvider =
    Provider<FlightRemoteDatasource>(
  (ref) => FlightRemoteDatasource(
    ref.read(flightDioProvider),
  ),
);


final homeRespositoryProvider =
    Provider<HomeRepository>(
  (ref) => HomeRepoImpl(
    ref.read(airportRemoteDataSourceProvider),ref.read(flightRemoteDataSourceProvider),
  ),
);
...
final homeUseCaseProvider =
  ...
  (ref) => HomeUseCase(
    ref.read(homeRespositoryProvider),
  ),
);
