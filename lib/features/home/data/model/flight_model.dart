...
class SearchResult {
  ...
  factory SearchResult.fromJson(Map<String, dynamic> json) =>
      SearchResult(tripInfos: TripInfos.fromJson(json["tripInfos"]));

  Map<String, dynamic> toJson() => {"tripInfos": tripInfos.toJson()};
}
...
class Onward {
  ...
  factory Onward.fromJson(Map<String, dynamic> json) => Onward(
    segmentInformation: List<SegmentInformation>.from(
      json["SegmentInformation"].map((x) => SegmentInformation.fromJson(x)),
    ),
  ...
  Map<String, dynamic> toJson() => {
    "SegmentInformation": List<dynamic>.from(
      segmentInformation.map((x) => x.toJson()),
    ),
...
enum AirFlowType { SEARCH }

final airFlowTypeValues = EnumValues({"SEARCH": AirFlowType.SEARCH});
...
class SegmentInformation {
  ...
  factory SegmentInformation.fromJson(Map<String, dynamic> json) =>
      SegmentInformation(
        ...
        stopOverairports: json["StopOverairports"] == null
            ? []
            : List<dynamic>.from(json["StopOverairports"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "StopOverairports": stopOverairports == null
        ? []
        : List<dynamic>.from(stopOverairports!.map((x) => x)),
    "duration": duration,
    "id": id,
...
enum City { CAMPBELLTOWN, DUBAI, FRANKFURT, GLASGOW, LONDON, MUMBAI }
...
enum CityCodeEnum { BOM, CAL, DXB, FRA, GLA, LCY, LHR, LON }
...
enum Country { GERMANY, INDIA, UNITED_ARAB_EMIRATES, UNITED_KINGDOM }
...
class Oac {
  ...
  Oac({required this.code, required this.isLcc, required this.name});
...
enum OacCode { AI, BA, CJ, EK, EMPTY, LH, LM }
...
class TotalPriceList {
  ...
  factory TotalPriceList.fromJson(Map<String, dynamic> json) => TotalPriceList(
    ...
    matchedSpecialReturnIdentifier: List<dynamic>.from(
      json["MatchedSpecialReturnIdentifier"].map((x) => x),
    ),
    priceId: json["PriceId"],
    specialReturnIdentifier: json["SpecialReturnIdentifier"],
    tripAdditionalInformation: TripAdditionalInformation.fromJson(
      json["TripAdditionalInformation"],
    ),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "MatchedSpecialReturnIdentifier": List<dynamic>.from(
      matchedSpecialReturnIdentifier.map((x) => x),
    ),
    "PriceId": priceId,
...
class FareDetail {
  ...
  FareDetail({required this.adult});

  factory FareDetail.fromJson(Map<String, dynamic> json) =>
      FareDetail(adult: FareDetailAdult.fromJson(json["ADULT"]));

  Map<String, dynamic> toJson() => {"ADULT": adult.toJson()};
}
...
class FareDetailAdult {
  ...
  factory FareDetailAdult.fromJson(Map<String, dynamic> json) =>
      FareDetailAdult(
        additionalFareComponents: AdditionalFareComponents.fromJson(
          json["AdditionalFareComponents"],
        ),
        baggageInformation: BaggageInformation.fromJson(
...
class AdditionalFareComponents {
  ...
  AdditionalFareComponents({required this.taxesAndFees});
  ...
  Map<String, dynamic> toJson() => {"TaxesAndFees": taxesAndFees.toJson()};
}
...
enum CabinBaggage { THE_7_KG }

final cabinBaggageValues = EnumValues({"7 Kg": CabinBaggage.THE_7_KG});
...
enum CabinClass { ECONOMY }

final cabinClassValues = EnumValues({"ECONOMY": CabinClass.ECONOMY});

enum ClassOfBooking { H, L, T, V, W }
...
enum FareBasis { TLNF00_S7, VGLM1, WGLM1, YNNF00_S1 }
...
enum FareIdentifier { ECONOMY_FULLY_FLEX, PUBLISHED }
...
class TripAdditionalInformation {
  ...
  TripAdditionalInformation({required this.tripBaggageInformation});

  factory TripAdditionalInformation.fromJson(Map<String, dynamic> json) =>
      TripAdditionalInformation(
        tripBaggageInformation: Map.from(json["TripBaggageInformation"]).map(
          (k, v) => MapEntry<String, List<TripBaggageInformation>>(
            k,
            List<TripBaggageInformation>.from(
              v.map((x) => TripBaggageInformation.fromJson(x)),
            ),
          ),
        ),
      );
  ...
  Map<String, dynamic> toJson() => {
    "TripBaggageInformation": Map.from(tripBaggageInformation).map(
...
class TripBaggageInformation {
  ...
  TripBaggageInformation({required this.adult});
...
class TripBaggageInformationAdult {
  ...
  TripBaggageInformationAdult({required this.cB, required this.iB});

  factory TripBaggageInformationAdult.fromJson(Map<String, dynamic> json) =>
...
class Status {
  ...
  Status({required this.httpStatus, required this.success});

  factory Status.fromJson(Map<String, dynamic> json) =>
      Status(httpStatus: json["httpStatus"], success: json["success"]);
